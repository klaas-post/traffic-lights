  ...
  for(i=0; i<datano; i++)
  {
    ...
    if(width >= bmp->width)
    {
      ...
      if(anz >= 10000)
      {
        ...
        if(bmp->datano != begin)
          MemMove(&bmp->ptr[bmp->datano], &bmp->ptr[begin], no*sizeof(_BMPDAT));
        bmp->datano += no;
...
//            bmp->ptr[n].col = LIGHTRED;
        ...
        while(add)
        {
          ...
          MemMove(&tmp[aktd], &bmp->ptr[begin], no*sizeof(_BMPDAT));
          aktd += no;
          add  --;
        }
...
//            bmp->ptr[n].col = LIGHTRED;
        ...
        while(add)
        {
          ...
          MemMove(&tmp[aktd], &bmp->ptr[begin], tsz);
          aktd += no;
          add  --;
        }
  ...
  for(i=0; i<datano; i++)
  {
    ...
    if(width >= bmp->width)
    {
      ...
      if(anz >= 10000)
      {
        ...
        if(bmp->datano != begin)
          MemMove(&ptr[bmp->datano], &ptr[begin], no*sizeof(_XBMPDAT256));
        bmp->datano += no;
...
//            bmp->ptr[n].col = LIGHTRED;
        ...
        while(add)
        {
          ...
          MemMove(&tmp[aktd], &ptr[begin], no*sizeof(_XBMPDAT256));
          aktd += no;
          add  --;
        }
