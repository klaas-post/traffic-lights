...
TYPE
  SvrCh__LightColor_PTofCls_TrafficLight : STRUCT
    pMeth : ^CHMETH;
    dData : TrafficLight::_LightColor;
    pDsc : ^SVRDSC;
  END_STRUCT;
  CltCh__LightColor_PTofCls_TrafficLight : STRUCT
    pCh : ^SvrCh__LightColor_PTofCls_TrafficLight;
    dData : TrafficLight::_LightColor;
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  SvrCh_DINT : STRUCT
